...
public class IndigencyStrategy implements DocumentProcessingStrategy {
    ...
    public String getHtmlTemplate() {
        ...
        <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 40px; border: 2px solid #000;">
            ...
            <h1 style="text-align: center; text-decoration: underline; margin-bottom: 40px;">CERTIFICATE OF INDIGENCY</h1>
            ...
            <p style="font-size: 1.2em; line-height: 1.8; text-indent: 40px; text-align: justify;">
                ...
                is a bonafide resident of <strong>{{address}}</strong>, Dalaguete, Cebu.
            </p>
            
            <p style="font-size: 1.2em; line-height: 1.8; text-indent: 40px; text-align: justify;">
                Our assessment indicates that the family income of the aforementioned resident falls below the poverty line configuration metrics defined for our local government unit, categorizing them as an indigent household.
            </p>
            
            <p style="font-size: 1.2em; line-height: 1.8; text-indent: 40px; text-align: justify;">
                This certification is being issued upon the request of the resident to support his/her application for: 
