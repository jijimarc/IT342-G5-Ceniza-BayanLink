...
public class CertificateOfGoodMoralCharacterStrategy implements DocumentProcessingStrategy {
    ...
    public String getHtmlTemplate() {
        ...
        <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 40px; border: 2px solid #000;">
            ...
            <h1 style="text-align: center; text-decoration: underline; margin-bottom: 40px;">CERTIFICATE OF GOOD MORAL CHARACTER</h1>
            ...
            <p style="font-size: 1.2em; line-height: 1.8; text-indent: 40px; text-align: justify;">
                ...
                and a registered resident of <strong>{{address}}</strong>, Dalaguete, Cebu, is an individual of exemplary standing within this community.
            </p>
            
            <p style="font-size: 1.2em; line-height: 1.8; text-indent: 40px; text-align: justify;">
                He/She possesses a clean civil standing and has no pending records of arbitration, active complaints, or blotter records logged under our local Lupon Tagapamayapa records.
            </p>
            
            <p style="font-size: 1.2em; line-height: 1.8; text-indent: 40px; text-align: justify;">
                This certification is issued upon his/her request for the purpose of: <strong>{{purpose}}</strong>.
            </p>
